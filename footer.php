            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 footer-newsletter">
                        ...
                        <p>You will receive notifications from us </p>
                        <form  method="post">
                            <input type="email" name="email" class='form-control mail'> <input type="submit" class='btn btn-primary mlbtn' value="Subscribe">
                        </form>
                    </div>
        ...
        <div class="container d-md-flex py-4">
            ...
            <div class="me-md-auto text-center text-md-start">
                ...
                <div class="credits">
                    ...
                    Designed by <a href="0531641798">Fremike Tech</a>
                </div>
            </div>
